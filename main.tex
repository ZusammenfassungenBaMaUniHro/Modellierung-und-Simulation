...
\section{Discrete Event System Specification (DEVS)}
	...
	\subsection{Gekoppelte Modelle}
		...
		\begin{itemize}
			...
			\item $Select: 2^{D} \rightarrow D$ die Funktion, die bestimmt wenn mehere Komponenten ein internes Ereignis ausführen wollen, welche Komponente priorisiert wird
